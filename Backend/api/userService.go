...
func CreateUser(user *model.User) (message string) {
	if !user.IsValid() {
...
func UpdateUserPhone(email string, phone string) (message string, err error) {
...
func UpdateUserName(email string, name string) (message string, err error) {
...
func DeleteUser(email string) (message string, err error) {
...
func VerifyUser(email string) (message string, err error) {
